        ...
        <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-2 bg-primary py-2">
                        <span
                            class="fs-4 text-dark"><?php echo $selected_data["fname"] . " " . $selected_data["lname"]; ?></span>
                    </div>
                    <div class="col-4 col-lg-2 d-lg-block bg-light py-2">
                    ...
                    <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                        <?php
                            ...
                            ?>
                        <button id="ub<?php echo $selected_data["email"]; ?>"
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">
                                <?php echo $selected_data["fname"] . " " . $selected_data["lname"]; ?></h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 d-grid">
                                        <button type="button" class="btn btn-primary"
                                            onclick="sendAdminMsg('<?php echo $selected_data['email']; ?>');">Send</button>
                                    </div>
                                </div>
                            </div>
